...
First, I remove low-quality cells.
In this step, I discard cells with an excessive proportion of mitochondrial genes or too few detected genes, as these often indicate damaged or low-quality cells.
...
Next, I filter out lowly expressed genes to reduce noise and focus on informative features.
Here, I retain only genes with at least one UMI detected in at least 5\% of all cells.
...
I then compute the normalization factors and normalize the data.
...
Here, I compute the first 50 principal components using the top variable genes.
...
In this step, I infer cell trajectories and compute pseudotime values using Slingshot, based on the PCA embedding and cluster identities (“labels”).
...
Now I visualize the pseudotime trajectory inferred by Slingshot along each lineage, by plotting the cells in PCA space and coloring them according to their pseudotime values.
